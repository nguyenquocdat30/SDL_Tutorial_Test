...
bool loadMedia()
{
	...
	// Load Up surface
	gKeyPressSurface[KEY_PRESS_SURFACE_UP] = loadSurface("Image/portal2.bmp");
	...
	// Load down surface
	gKeyPressSurface[KEY_PRESS_SURFACE_DOWN] = loadSurface("Image/portal3.bmp");
	...
	// Load left surface
	gKeyPressSurface[KEY_PRESS_SURFACE_LEFT] = loadSurface("Image/portal4.bmp");
	...
	// Load right surface
	gKeyPressSurface[KEY_PRESS_SURFACE_RIGHT] = loadSurface("Image/portal5.bmp");
